...
class CsharpHighlighter(QSyntaxHighlighter):
    """Syntax highlighter for the Csharp language.
    """
    # Csharp keywords
    ...
    keywords = [
        ...
        'short', 'sizeof', 'stack', 'alloc', 'static', 'string', 'struct', 'switch', 'this', 'throw', 'true'
        'try', 'typeof', 'unit', 'ulong', 'unchecked', 'unsafe', 'ushort', 'using', 'using', 'static',
    ...
    def __init__(self, document):
        ...
        # FIXME: The triple-quotes in these two lines will mess up the. ANSWER: NO THIS IS YOUR GRAD PROJ FIX IT YOURSELF!
